    ...
    elseif(!in_array($_FILES['image1']['type'],$format))
	{
        ...
        elseif($_FILES['image1']['size']<=$maxsize && in_array($_FILES['image1']['type'],$format))
		{
								$change="";
									...
									$filename = "../administrator-srs/SHE/gambarevent/". $_FILES['image1']['name'];
						...
						$query = "insert into event_report values('$cookievent','$id_user','$_POST[id_jeniskejadian]', '$_POST[deskripsi]','','$foto_videox1',now(),'$lat', '$long','$kode_bandara')";
